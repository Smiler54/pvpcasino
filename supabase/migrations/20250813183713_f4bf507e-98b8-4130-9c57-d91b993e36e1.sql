-- CRITICAL SECURITY FIX: Restrict access to gambling seeds (corrected)
...
DROP POLICY IF EXISTS "Participants can view their own complete matches" ON public.game_matches;
...
-- 2. Create secure policies that protect gambling seeds
CREATE POLICY "Participants only can view their matches" 
