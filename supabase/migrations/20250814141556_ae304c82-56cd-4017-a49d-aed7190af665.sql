-- Update the buy_jackpot_tickets function to set exactly 1 minute (60 seconds) timer for first bet
...
BEGIN
  ...
  -- Handle timer logic: 1 minute (60 seconds) base + 5 seconds per new player, max 90 seconds
  ...
  IF v_current_players = 1 THEN
    -- First player: start exactly 1 minute (60 seconds) timer
