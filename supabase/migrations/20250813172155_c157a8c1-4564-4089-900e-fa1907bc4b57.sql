-- Now complete the coinflip test with the correct transaction type
...
BEGIN
  ...
  -- Simulate hash calculation (using random for demo)
  ...
  -- Update winner's balance using coinflip_win transaction type
  PERFORM public.update_user_balance(
    v_winner_id,
    v_win_amount,
    'coinflip_win',  -- Now this transaction type is allowed
  ...
  RAISE NOTICE 'Maker bet heads, taker bet tails. Random result determined the winner!';
