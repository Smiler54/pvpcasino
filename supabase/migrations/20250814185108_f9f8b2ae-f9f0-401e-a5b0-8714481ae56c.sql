-- Drop and recreate functions to change their return types
DROP FUNCTION IF EXISTS public.get_public_jackpot_stats();
DROP FUNCTION IF EXISTS public.get_jackpot_public_stats();
...
-- Recreate get_public_jackpot_stats function without timer fields
...
-- Recreate get_jackpot_public_stats function without timer fields
