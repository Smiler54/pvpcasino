...
-- Function to create admin user with high credits
...
DECLARE
  ...
  v_result JSON;
BEGIN
  -- Insert into profiles with a very high balance (99,999,999.99 - effectively unlimited for gaming)
  INSERT INTO public.profiles (user_id, username, balance)
  VALUES (gen_random_uuid(), p_username, 99999999.99)
